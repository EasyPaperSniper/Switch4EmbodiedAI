...
class ROMP_MocapModuleConfig(BaseConfig):
    ...
    onnx = True    # Whether to use ONNX for acceleration.
    ...
    smpl_path = osp.join(ROOT_DIR, 'utils', 'romp','SMPL_NEUTRAL.pth') # The path of smpl model file
    model_path = osp.join(ROOT_DIR, 'utils', 'romp', 'ROMP.pkl') # The path of ROMP checkpoint
    model_onnx_path = osp.join(ROOT_DIR, 'utils', 'romp', 'ROMP.onnx') # The path of ROMP onnx checkpoint
